...
export default function BlogGrid({ blogs, renderContent, formatDate }: BlogGridProps) {
                ...
                {blogs.data.length > 0 ? (
                    <>
                        ...
                        <div className={`mb-8 text-sm text-gray-600 ${isRTL ? 'text-right font-arabic' : ''}`}>
                            {t('blog.resultsCount', { count: blogs.total }) || `${blogs.total} articles found`}
                        </div>
                    ...
                    <div className="text-center py-16">
                        ...
                        <p className={`text-gray-600 ${isRTL ? 'font-arabic' : ''}`}>
                            {t('blog.noResultsDescription') || 'Try adjusting your search or filter criteria.'}
                        </p>
                    </div>
                )}
            </div>
