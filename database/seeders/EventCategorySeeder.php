    ...
    public function run(): void
    {
        $categories = [
            [
                ...
                'receiver_email' => 'conferences@dhl.com',
                'sort_order' => 1,
            ],
            [
                ...
                'receiver_email' => 'workshops@dhl.com',
                'sort_order' => 2,
            ],
            [
                ...
                'receiver_email' => 'training@dhl.com',
                'sort_order' => 3,
            ],
            [
                ...
                'receiver_email' => 'networking@dhl.com',
                'sort_order' => 4,
            ],
            [
                ...
                'receiver_email' => 'products@dhl.com',
                'sort_order' => 5,
            ],
            [
                ...
                'receiver_email' => 'webinars@dhl.com',
                'sort_order' => 6,
            ],
        ];
